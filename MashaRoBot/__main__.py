...
• `/help`*:* PM's you this message[.](https://telegra.ph/file/de987fd17fbdd24231d5a.jpg)
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Tracy*, a powerful group management bot built to help you manage your group easily.
